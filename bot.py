...
giga = GigaChat(
    credentials="Yzg5YjFhN2ItNGQyYi00N2I5LWIyMjQtN2EzZWUzMGEwMmZjOjhiYWExZjQ3LTNmMjUtNDk0MC1iNjdjLTg1ZjNhMGZjNDAyNw==",
...
def main() -> None:
    token = "8041923509:AAG9pmYWZu1yDo4zFCYMZxjjqIQTmkShXiw"
    if not token:
